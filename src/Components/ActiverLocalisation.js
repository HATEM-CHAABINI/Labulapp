    ...
    <View style={{ flex: 1, bottom: 40 * hm, backgroundColor: "#F0F5F7" }}>
      ...
      <View style={{ flex: 1 }}>
        <View style={styles.ActionWrapper}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('ActiverLaNotif')} style={{
            overflow: 'hidden',
            borderRadius: 18 * em,
            height: 59 * hm,
            width: 315 * em,
          ...
          {loading ? <ActivityIndicator size='small' color='#1E2D60' style={{ marginLeft: 25 * em, }} /> :<Text style={{ color: '#6A8596', fontSize: 16 * em }} onPress={()=>login()}>Activer plus tard</Text>}
          </View>
