...
import {
  Button, View, Text, Image, TextInput, ImageBackground,
  ...
  render() {
    ...
    return (
      ...
      <View style={{ flex: 1, flexDirection: "column" }}>
        ...
        <ImageBackground source={require('../assets/img/homepage/carte.png')} style={{
          flex: 1,
          resizeMode: "cover",
          ...
          <View style={{ flex: 1, paddingTop: 50 * em, alignItems: 'center' }}>
            <TitleBlue width={30 * em} height={30 * em} />
          </View>
          <Selector navigation={navigation} ini={0} />
          <Menu />
        </ImageBackground>
