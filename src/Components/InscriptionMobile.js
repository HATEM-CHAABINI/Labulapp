...
<View style={{flex:10}}>
                ...
                <Text style={{color:'#1E2D60',fontSize:28*em,paddingTop:79*hm,fontFamily:'lato-Black'}}>Mon mobile</Text>
   
                <View style={styles.contentWrapper}>
              <Text style={styles.descText}>Quel est ton numéro de téléphone ?</Text>
              <MyTextInput style={styles.TextInput} textContentType={"telephoneNumber"} keyboardType="number-pad" autoFocus={true} value={this.state.mobile} handleChange={(text)=>this.setState({mobile:text})} />
              <MyTextInput />
