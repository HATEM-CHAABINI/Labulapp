  ...
  return (
    ...
    <Image
        ...
        <View style={styles.body}>
          ...
          <CommonButton leftIcon={<Up width={20* em} height={18 * hm} />} text={'Participer'} onPress={() => props.servicetype=="organize"? setParticipatePopupVisible(true):<></>
          } style={{width:185*em,height:50*hm,paddingVertical: 0 * hm}} textStyle={{marginLeft:10*em}} />
