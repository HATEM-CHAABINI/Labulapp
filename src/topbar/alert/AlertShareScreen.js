...
const AlertShareScreen = (props) => {
  return (
    ...
    < >
          ...
          <MabulRechercheContact shareEdit={props.shareEdit} txt={props.txt} data={props.item} mabulService={props.mabulService} conceptColor={props.conceptColor} rb4={props.close}/>
        {/* </RBSheet> */}
